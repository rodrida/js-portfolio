...
// añadimos el soporte para CssMinimizer (optimizar el CSS)
const CssMinimizerPlugin = require('css-minimizer-webpack-plugin');
// añadimos el soporte para Terser (optimizar el js)
const TerserPlugin = require('terser-webpack-plugin');
// añadimos el soporte para las variables de entorno
const Dotenv = require('dotenv-webpack');
// añadimos el soporte para Clean Webpack
...
module.exports = {
    ...
    plugins: [
        ...
        new Dotenv(),
        // añadimos el plugin de Clean Webpack
        new CleanWebpackPlugin()
    ],
    // añadimos el soporte de optimización
    optimization: {
        minimize: true,
        minimizer: [
...
// cada vez que hagamos un compilado para producción, queremos garantizar que se va a limpiar está
// estructura y que vamos a tener siempre lo último cada que ejecutamos este comando,
// para eso instalamos un plugin que se llama Clean Webpack
// ejecutamos en la terminal: npm install clean-webpack-plugin -D
...
// también podemos ejecutar en la terminal el script que activa el modo Watch: npm run build:watch